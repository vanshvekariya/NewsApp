...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5c3c5502baff4defae27482adda7d381&page=${this.state.page}&pageSize=${this.props.pageSize}`;
